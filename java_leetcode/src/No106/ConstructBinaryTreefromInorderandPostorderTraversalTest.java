...
class ConstructBinaryTreefromInorderandPostorderTraversalTest {
    ...
    void test_main() {
        ...
        TreeNode node_1 = a.buildTree_v2(inorder_1, postorder_1);
        ...
        TreeNode node_2 = a.buildTree_v2(inorder_2, postorder_2);
        ...
        TreeNode node_3 = a.buildTree_v2(inorder_3, postorder_3);
