...
class ConstructBinaryTreefromPreorderandInorderTraversalTest {
    ...
    void test_main() {
        ...
        TreeNode node_1 = a.buildTree_v2(preorder_1, inorder_1);
        ...
        TreeNode node_2 = a.buildTree_v2(preorder_2, inorder_2);
        ...
        TreeNode node_3 = a.buildTree_v2(preorder_3, inorder_3);
